...
//    @TODO
    ...
    /* TX Functions */
    #define imuUart_putChar(ch) UART_IMU_UartPutChar(ch)  /**< Wrapper for UART TX function */
    
    /* RX functions */
    #define imuUart_RX_EN  1        /**< Is receiving enabled? */
    #if imuUart_RX_EN
        #define imuUart_getChar() UART_IMU_UartGetChar() /**< Wrapper for UART RX function */
    #endif /* imuUart_RX_EN */
